...
/* package warehouse-log-0.1.0.0 */
#ifndef VERSION_warehouse_log
#define VERSION_warehouse_log "0.1.0.0"
#endif /* VERSION_warehouse_log */
#ifndef MIN_VERSION_warehouse_log
#define MIN_VERSION_warehouse_log(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_warehouse_log */
...
#define CURRENT_COMPONENT_ID "warehouse-log-0.1.0.0-inplace-warehouse-log"
