...
/* package trofi-0.1.0.0 */
#ifndef VERSION_trofi
#define VERSION_trofi "0.1.0.0"
#endif /* VERSION_trofi */
#ifndef MIN_VERSION_trofi
#define MIN_VERSION_trofi(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_trofi */
...
#define CURRENT_COMPONENT_ID "trofi-0.1.0.0-inplace-warehouse-log"
